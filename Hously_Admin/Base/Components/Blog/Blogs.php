    ...
    <div class="relative p-6">
        <div class="">
            <div class="flex justify-between mb-4">
                <span class="text-slate-400 text-sm"><i class="mdi mdi-calendar-month align-middle text-base text-slate-900 dark:text-white me-2"></i><?php echo $item['date']; ?></span>
            ...
            <div class="mt-3">
                <a href="blog-detail.php?id=<?php echo $item['id']; ?>" class="btn btn-link hover:text-green-600 after:bg-green-600 duration-500 ease-in-out">Read More <i class="mdi mdi-chevron-right"></i></a>
            </div>
        </div>
    </div>
</div>
