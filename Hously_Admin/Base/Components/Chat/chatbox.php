...
<a href="#" class="<?php echo $item['style']; ?>">
    <div class="relative">
        <img src="<?php echo $static_url, $item['img']; ?>" class="size-11 rounded-full shadow dark:shadow-gray-700" alt="">
        <?php if ($item['status'] === 'online'): ?>
    ...
    <div class="overflow-hidden flex-1 ms-2">
        ...
        <div class="flex justify-between">
            <span class="<?php echo $item['class']; ?>"><?php echo $item['message']; ?></span>
            <?php if ($item['unread'] > 0): ?>
                <span class="flex items-center justify-center bg-red-600/20 text-red-600 text-[10px] font-bold rounded-full w-5 max-h-5"><?php echo $item['unread']; ?></span>
            <?php endif; ?>
        </div>
    </div>
</a>
